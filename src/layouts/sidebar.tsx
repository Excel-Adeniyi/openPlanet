...
export default function SideBar() {
  ...
  return (
    <div
      className={`${
        isOpen ? 'show_sidebar' : ''
      } fixed h-full bg-slate-700 sidebar_container text-white `}
    >
      <div className='grid grid-cols-2'>
        <div className='logo_gradient_sidebar flex mx-4 my-4 items-stretch justify-self-start '>
          <img
        ...
        <div
          className='my-3 flex justify-end mx-3 cursor-pointer'
          onClick={() => toggleBar()}
        >
      ...
      <div className='text-3xl mx-4 font-cormorantBold menus_styles mt-10'>
        <div className='my-4'>
          <Link
            to={'/'}
            className={`text-white focus:text-red-400 ${
        ...
        <div className='my-4'>
          <Link
            to={'/team'}
            className={`text-white focus:text-red-400 ${
              pathname === '/team' ? 'text-red-400' : 'text-white'
            }`}
            onClick={() => {
              toggleBar();
            }}
        ...
        <div
          className='my-4 text-white focus:text-red-400 '
          onClick={() => {
            toggleModal(), toggleBar();
          }}
        >
      ...
      <div className='mt-6'>
        ...
        <div className='flex justify-center text-white'>
          ...
          <div
            className='p-4 text-xl hover:text-red-700 focus:text-red-700'
